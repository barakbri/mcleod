...
#'
#' @details Details the type of prior for the random effect model. The prior for the distribution of random effects can be either Heirarchical Beta (a Polya Tree, i.e. a full binary tree with L levels, with each leaf corresponding to a segment on the real line) or a two level dirichlet tree. See additional details in the package vignette.
#'
...
#' @param Two.Layer.Dirichlet.Nodes.in.First.Layer Number of nodes in the first level of the dirichelt tree. \code{Two.Layer.Dirichlet.Intervals} must be an integer multiple of \code{Two.Layer.Dirichlet.Nodes.in.First.Layer}
#'
...
#' @param integration_step_size Used for numerical integration when computing the probability for an observed value to originate from a given segment of the underlying density
...
#' \item{a.vec}{ - BAR.}
#' \item{nr.gibbs}{ - BAR.}
#' \item{nr.gibbs.burnin}{ - BAR.}
#' \item{prior_parameters}{ - BAR.}
#' \item{computational_parameters}{ - BAR.}
#' \item{covariates_estimation_parameters}{ - BAR.}
#' \item{covariates}{ - BAR.}
#' \item{x.smp}{ - BAR.}
#' \item{n.smp}{ - BAR.}
#' \item{Noise_Type}{ - BAR.}
#' \item{covariates_given}{ - BAR.}
#' }
#'
...
#' \item{pi_smp}{ - BAR.}
#' \item{beta_smp}{ - BAR.}
#' \item{beta_suggestion}{ - BAR.}
#' \item{proposal_approved}{ - BAR.}
#' \item{elapsed_secs}{ - BAR.}
#' \item{ll_proposal}{ - BAR.}
#' \item{ll_current}{ - BAR.}
#' \item{FOO}{ - BAR.}
#' \item{FOO}{ - BAR.}
#' }
