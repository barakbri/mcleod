...
plot(res$parameters_list$a.vec, #the X axis is the series of breaks defined by \vec{a}
     # Y is the cumulative probability: starts at zero, and sums over 
     # the values of \vec{\pi} for the different segments
     c(0,cumsum(res$additional$original_stat_res$pi_smp[,iter_number])) 
     , type = 'l' )
```
...
### Example 2: Coefficients intialized by normal random intercept binomiall regression, change priors for $\vec{\beta}$
