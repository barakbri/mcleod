...
(2) Sample bootstrap samples, for each sample generate point estiamte
(3) Compute PV, explain rho


- Describe what happens in LE

- Say some words on computational efficiency: MONOTONICITY, LE VS GE, STOP-EARLY, START TESTING FROM THE NOISELESS CASE, MULTIPLE PROCESSES.
